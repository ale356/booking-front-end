...
import { Typography, Button, Box, TextField, Select, MenuItem, FormControl, InputLabel, Alert } from '@mui/material';
...
const EditAppointmentPage = () => {
  ...
  return (
    <Box m={4}>
      <Typography variant="h4" sx={{ ...customTheme.typography.h4, textAlign: 'center', paddingTop: customTheme.spacing(3), paddingBottom: customTheme.spacing(3) }}>Edit Appointment</Typography>
      {editField === 'time' && (
